...
\newcommand{\autor}{Václav Honzík}           % zde VYPLŇTE své jméno a příjmení
\newcommand{\rok}{2013}                % zde VYPLŇTE rok odevzdání, např. 2006
...
\newcommand{\pracovisteKonz}{Union College, Schenectady USA} % POKUD MÁTE konzultanta, NAPIŠTE jeho pracoviště


\newcommand{\klicova}{keywords cz}   % zde NAPIŠTE česky max. 5 klíčových slov
\newcommand{\keyword}{keywords en}       % zde NAPIŠTE anglicky max. 5 klíčových slov (přeložte z češtiny)
\newcommand{\abstrCZ}{abstract cz} % zde NAPIŠTE abstrakt v češtině
\newcommand{\abstrEN}{abstract en}                  % zde NAPIŠTE abstrakt v angličtině
...
%\input{zaver.tex}  % Závěr, je vkládán z jiného souboru
